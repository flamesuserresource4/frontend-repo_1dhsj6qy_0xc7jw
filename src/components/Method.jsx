...
export default function Method() {
  return (
    <section id="method" className="relative py-20 sm:py-24 bg-gradient-to-b from-amber-100 to-stone-50">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {steps.map(({ icon: Icon, title, desc }) => (
            <div key={title} className="group rounded-2xl border border-amber-200 bg-amber-50 p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="inline-flex h-10 w-10 items-center justify-center rounded-md bg-stone-900 text-amber-50">
                <Icon size={18} />
              </div>
